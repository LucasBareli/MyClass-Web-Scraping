...
URL_magazine = 'https://lista.mercadolivre.com.br/celulares#D[A:celulares]'
...
titulos_magazine = soup_magazine.find_all(class_='poly-component__title')
precos_magazine = soup_magazine.find_all(class_='andes-money-amount andes-money-amount--cents-superscript')
...
df.to_excel('celulares_americanas.xlsx', index=False)

print("Dados salvos e ordenados em 'celulares_americanas.xlsx'")